...
\newpage
\doublespacing
\section*{Appendix A: Use of AI}
I used ChatGPT models 4o, o1, and o3-mini each to see if any were able to provide accurate
recaps of the current transportation economics literature, and also to see if they could
find me relevant literature which I hadn't encountered yet. I found that given a broad
prompt, e.g., "tell me about induced traffic demand" or "does congestion pricing work",
ChatGPT could give me an accurate overview answer to my question. However, when pressed
for sources, ChatGPT would seem to give me one or two real, but loosely related sources,
and then it would make them up. It would cite a very real sounding article like:
“Equity and Efficiency in Urban Road Pricing: Evidence from Metropolitan Case Studies”,
but when you searched that, nothing would turn up.

So, for the last few weeks of the semester, I have been using the ScholarGPT API on
ChatGPT. As far as I know, it has only a few differences, still using the ChatGPT backend.
However, all of its answers seem to follow a standardized template (helpful for consistency),
and it seemed to have complete access to Google Scholar. To find sources using it,
it would need a relatively specific prompt; the model is coded to pick from the relevant
literature and cite it when responding. ScholarGPT and Consensus (another alternative I tried)
fall short when you prompt them to explain a line from the text that you need clarification on,
and it's here I'm reminded that they still use the ChatGPT backend, which is prone to hallucination
when asked too-specific a question. Both ScholarGPT and Consensus hallucinated "context";
say, a line from the text which doesn't actually exist. For that reason, I could really
only reliably use AI to find sources and summarize them, but any specific questions I
had wouldn't be guaranteed a good answer.

This shouldn't be a surprise, as by necessity, published literature in niche areas may not
have a ton of overlap to provide additional context. So when you ask an AI a specific
economics question that comes up in a single paper, it doesn't have any other sources besides
that paper to aggregate for you in its response, and this is where it falls flat.

\newpage
\section*{Appendix B: Feedback Use}
Peer and instructor feedback have been essential in every single aspect of the
final revision. To begin, the instructor's focus on constantly narrowing down
the scope of the research question (so that we wouldn't have something so broad)
was probably the most critical step for me (and I suspect for my classmates as well).
Now, not only do I have a proposal that can actually be specific in its data collection
and methodology, but also a testable research question which can feasibly be done in the timeline
of a year. This is coming down from a much more broad research question that was more like
"what's the best transportation policy for Connecticut?".

The feedback on my draft really helped me organize my proposal as well. I lacked structure
in my first draft, which made its goals difficult to interpret. I didn't even have section headers,
and wrote it more like a narrative than a
true academic research proposal. Which my prose may have been acceptable, it did not have
the structure required to clearly convey my ideas--i.e., sections which were independently
interpretable, which is a must for anyone who'd be interested in my work. 
Feedback from one peer
noted my proposal's ambiguous methodology, which prompted me to expand by doing some preliminary
model specification. It was also noted that I lacked concrete data sources, so in my
review I took care to find the data sources that the extant literature used, which can be
extended to my application.

Peer feedback was incredibly useful in having correct citation style. While a simple task,
I was unfamiliar with the CMOS Author-Date system at the beginning of the semester, and instructor
feedback noted that note only did I have some in-text citations wrong, but the formatting for my
references was completely incorrect. (If I ever hope to have future work published, I'm going to
have to start by sending the correct format to any journals). This was only my second foray into using
citations with \LaTeX, which will no doubt be useful
